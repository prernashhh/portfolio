        ...
        >
          <div className="mb-8 relative overflow-hidden rounded-lg">
           ...
           <p className={`text-lg mb-4 ${darkMode ? 'text-gray-300' : 'text-spooky-gray'}`}>
            ...
            <p className={`text-lg mb-4 ${darkMode ? 'text-gray-300' : 'text-spooky-gray'}`}>
              With a strong foundation in the <span className={darkMode ? 'text-horror-red' : 'text-spooky-red font-semibold'}>MERN stack</span>, JavaScript, Tailwind CSS, React, Node.js, and Git, 
              I enjoy building full-stack applications that are clean, responsive, and performance-optimized. 
              My projects include blog apps deployed on Vercel, interactive platforms with sorting UX, and payment gateway integrations like Razorpay.
            </p>

            <p className={`text-lg ${darkMode ? 'text-gray-300' : 'text-spooky-gray'}`}>
              Whether I'm translating ideas into intuitive interfaces, debugging deployment issues, or optimizing with hooks like useMemo and useCallback, 
              I approach every project with an eye for detail. 
              This portfolio showcases that journey in full-stack development, thanks for stopping by!
          </p>
        </div>
      </div>
    </section>
