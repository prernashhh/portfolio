...
const Experience = () => {
  ...
  return (    <section id="experience" className="py-16 md:py-20 relative">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {/* Work Experience 1 - Trickwrick */}
          <div className={`${darkMode ? 'bg-horror-black/50' : 'bg-spooky-cream/50'} backdrop-blur-sm p-6 md:p-8 rounded-lg shadow-xl mb-8`}
              ...
              <div className="lg:w-2/3">
                <ul className={`space-y-4 ${darkMode ? 'text-gray-300' : 'text-spooky-gray'} text-sm md:text-base`}>
                  <li className="flex items-start">
                    ...
                    <span>Contributed to internal and client-facing projects using MERN and Vite</span>
                  </li>
                  <li className="flex items-start">
                    <span className={`inline-block w-2 h-2 ${darkMode ? 'bg-horror-red' : 'bg-spooky-red'} rounded-full mt-2 mr-4 flex-shrink-0`}></span>
                    <span>Implemented scalable, SEO-optimized web applications with responsive UI and API integrations</span>
                  </li>
                </ul>
              </div>
            </div>
