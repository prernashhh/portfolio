...
import blogBaseLogo from '../assets/blogbaselogo.jpg';

const projects = [
  {
    id: 1,
    title: "BlogBase",
    description: "Developed a blogging platform with a custom admin panel, SEO-friendly slugs, and rich text support. Deployed on Vercel with MongoDB Atlas and secure Mongoose APIs.",
    image: blogBaseLogo,
    tags: ["Next.js", "TypeScript", "React-Quill", "MongoDB", "Vercel"],
    link: "https://blog-app-blogbase.vercel.app/",
    repo: null
  },
  {
    id: 2,
    title: "Kalakendra",
    description: "Developed a comprehensive platform connecting artists and learners for workshops, featuring role-based authentication, booking system, secure payments, media portfolios, and responsive dashboards.",
    useCustomDisplay: true,
    customDisplay: (
      <div className="w-32 h-32 bg-gradient-to-br from-yellow-400 to-amber-500 rounded-2xl flex items-center justify-center shadow-lg">
        <span className="text-white font-serif font-bold text-6xl">K</span>
      </div>
    ),
    tags: ["MERN", "Vite", "Razorpay", "Cloudinary"],
    link: "https://kalakendra-lilac.vercel.app/",
    repo: null
  },
  {
    id: 3,
                  ...
                  <>
                    <img 
                      ...
                      className={`w-full h-full ${
                        ...
                        project.id === 5 ? 'object-contain p-4 scale-75' : 
                        'object-cover'
